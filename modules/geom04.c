...
void init_gamma04()
{
    ...
    // gammaH1
    gsl_matrix_complex_set(gammaH[1], 0, 1, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaH[1], 1, 0, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gammaH[1], 2, 3, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaH[1], 3, 2, gsl_complex_rect(0.0, -1.0));
 
    // gammaH2
    gsl_matrix_complex_set(gammaH[2], 0, 1, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gammaH[2], 1, 0, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gammaH[2], 2, 3, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gammaH[2], 3, 2, gsl_complex_rect(1.0, 0.0));
 
    // gammaH3
    gsl_matrix_complex_set(gammaH[3], 0, 3, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaH[3], 1, 2, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaH[3], 2, 1, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gammaH[3], 3, 0, gsl_complex_rect(0.0, -1.0));
 
    // gammaL0
    gsl_matrix_complex_set(gammaL[0], 0, 0, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaL[0], 1, 1, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaL[0], 2, 2, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gammaL[0], 3, 3, gsl_complex_rect(0.0, -1.0));
 
    // gammaL1
    gsl_matrix_complex_set(gammaL[1], 0, 2, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gammaL[1], 1, 3, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gammaL[1], 2, 0, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gammaL[1], 3, 1, gsl_complex_rect(-1.0, 0.0));
 
    // gammaL2
    gsl_matrix_complex_set(gammaL[2], 0, 2, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaL[2], 1, 3, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gammaL[2], 2, 0, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gammaL[2], 3, 1, gsl_complex_rect(0.0, -1.0));
 
    // gammaL3
    gsl_matrix_complex_set(gammaL[3], 0, 3, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gammaL[3], 1, 2, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gammaL[3], 2, 1, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gammaL[3], 3, 0, gsl_complex_rect(-1.0, 0.0));
}


void actionD2t04(double* vecS, int* control)
{
    ...
    if(control[0])
    vecS[0] = +8*dim*GSL_REAL(trH1H1)+8*GSL_REAL(gsl_complex_mul(trH1,trH1))+8*GSL_REAL(gsl_complex_mul(trH3,trH3))+8*dim*GSL_REAL(trL1L1)+8*dim*GSL_REAL(trH0H0)+8*dim*GSL_REAL(trH2H2)+8*dim*GSL_REAL(trL2L2)+8*dim*GSL_REAL(trH3H3)+8*GSL_REAL(gsl_complex_mul(trH2,trH2))+8*dim*GSL_REAL(trL0L0)+8*GSL_REAL(gsl_complex_mul(trH0,trH0))+8*dim*GSL_REAL(trL3L3);
    if(control[1])
    vecS[1] = +8*dim*GSL_IMAG(trH1H1)+8*GSL_IMAG(gsl_complex_mul(trH1,trH1))+8*GSL_IMAG(gsl_complex_mul(trH3,trH3))+8*dim*GSL_IMAG(trL1L1)+8*dim*GSL_IMAG(trH0H0)+8*dim*GSL_IMAG(trH2H2)+8*dim*GSL_IMAG(trL2L2)+8*dim*GSL_IMAG(trH3H3)+8*GSL_IMAG(gsl_complex_mul(trH2,trH2))+8*dim*GSL_IMAG(trL0L0)+8*GSL_IMAG(gsl_complex_mul(trH0,trH0))+8*dim*GSL_IMAG(trL3L3);
    if(control[2])
...
void actionD4D2t04(double* vecS, int* control)
{
    gsl_matrix_complex* H0 = H[0];
    gsl_complex trH0 = trace(H0);
    gsl_matrix_complex* H1 = H[1];
    ...
    if(control[0])
    vecS[0] = G*(+8*dim*GSL_REAL(trH1H1)+8*GSL_REAL(gsl_complex_mul(trH1,trH1))+8*GSL_REAL(gsl_complex_mul(trH3,trH3))+8*dim*GSL_REAL(trL1L1)+8*dim*GSL_REAL(trH0H0)+8*dim*GSL_REAL(trH2H2)+8*dim*GSL_REAL(trL2L2)+8*dim*GSL_REAL(trH3H3)+8*GSL_REAL(gsl_complex_mul(trH2,trH2))+8*dim*GSL_REAL(trL0L0)+8*GSL_REAL(gsl_complex_mul(trH0,trH0))+8*dim*GSL_REAL(trL3L3)) -32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H1L0,trH2)))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH2L2H3)))+32*dim*GSL_REAL(trH0L3H3L0)+32*GSL_REAL(gsl_complex_mul(trH2,trH2H2H2))-32*GSL_REAL(gsl_complex_mul(trH2L1,trH2L1))-32*GSL_REAL(gsl_complex_mul(trH1L2,trH1L2))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L3L1L2))+48*GSL_REAL(gsl_complex_mul(trH0H0,trL2L2))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L2H2,trH3)))+32*GSL_REAL(gsl_complex_mul(trH0,trH3L0L3))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H2L3H3))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L0H1,trH2)))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3H2H3))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1H1H3))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L0L3L1))+32*GSL_REAL(gsl_complex_mul(trH1,trH2L1L2))-96*GSL_REAL(gsl_complex_mul(trH2L2,trH2L2))-96*GSL_REAL(gsl_complex_mul(trH0L2,trH0L2))-96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trL0L1L3)))+24*GSL_REAL(gsl_complex_mul(trH1H1,trH1H1))-96*GSL_REAL(gsl_complex_mul(trH1L1,trH1L1))-32*dim*GSL_REAL(trH1L0H3L2)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0L1L2))-96*GSL_REAL(gsl_complex_mul(trH3L2,trH3L2))+64*GSL_REAL(gsl_complex_mul(trH0H1,trL2L3))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H2L2,trH3)))+32*dim*GSL_REAL(trH1H1L0L0)-32*dim*GSL_REAL(trH1L2L1H2)-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H1L1,trH3)))-32*GSL_REAL(gsl_complex_mul(trH1L2L0,trH3))-16*dim*GSL_REAL(trL0L3L0L3)-32*GSL_REAL(gsl_complex_mul(trH0,trH2L3L1))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH2H3L2)))-16*dim*GSL_REAL(trH1H3H1H3)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3L1L0))+32*GSL_REAL(gsl_complex_mul(trH2H2H3,trH3))-32*dim*GSL_REAL(trH2H3L0L1)+32*dim*GSL_REAL(trH0H0H2H2)+96*GSL_REAL(gsl_complex_mul(trH3,trH3L1L1))-32*dim*GSL_REAL(trH2L1L0H3)-96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH3,trL1L2L3)))+32*GSL_REAL(gsl_complex_mul(trH0,trH0H2H2))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1H2L0)))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2H3L2))+32*GSL_REAL(gsl_complex_mul(trH1H1H2,trH2))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L1L3L2))+24*GSL_REAL(gsl_complex_mul(trH2H2,trH2H2))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2L0L1))+64*GSL_REAL(gsl_complex_mul(trH1L0,trH3L2))+32*dim*GSL_REAL(trH2H2L3L3)+32*dim*GSL_REAL(trH1H2L2L1)+96*GSL_REAL(gsl_complex_mul(trH0,trH0L0L0))+32*GSL_REAL(gsl_complex_mul(trH3,trH3H3H3))+32*dim*GSL_REAL(trH0H0L0L0)+32*dim*GSL_REAL(trL1L1L3L3)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2H1L0))-32*dim*GSL_REAL(trH0L3H2L1)+16*GSL_REAL(gsl_complex_mul(trL0L0,trL2L2))+32*dim*GSL_REAL(trH0L0L3H3)+16*GSL_REAL(gsl_complex_mul(trL1L1,trL3L3))-96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH2,trL0L2L3)))+96*GSL_REAL(gsl_complex_mul(trH3,trH3L3L3))+16*dim*GSL_REAL(trH2L0H2L0)+32*GSL_REAL(gsl_complex_mul(trH0H3,trH0H3))-16*dim*GSL_REAL(trH0H1H0H1)+32*dim*GSL_REAL(trH2H2L2L2)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L0L3L2))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L3L2L1))-32*dim*GSL_REAL(trH1L2H3L0)+16*dim*GSL_REAL(trH0L1H0L1)-16*dim*GSL_REAL(trL1L3L1L3)-96*GSL_REAL(gsl_complex_mul(trH1L3,trH1L3))+96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH2,trL0L3L2)))-32*dim*GSL_REAL(trH0H2L3L1)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3H2L2))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3L1H1))+32*dim*GSL_REAL(trH0L0H3L3)+64*GSL_REAL(gsl_complex_mul(trH1H2,trL1L2))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1L3H2,trH3)))+16*GSL_REAL(gsl_complex_mul(trH2H2,trH3H3))+32*dim*GSL_REAL(trH3H3L2L2)-32*dim*GSL_REAL(trH0L1H2L3)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1L1H3))+32*dim*GSL_REAL(trL0L0L1L1)+32*GSL_REAL(gsl_complex_mul(trH0,trH3L3L0))-32*dim*GSL_REAL(trH0L3L2H1)+32*GSL_REAL(gsl_complex_mul(trL0L3,trL0L3))+96*GSL_REAL(gsl_complex_mul(trH2,trH2L2L2))+32*dim*GSL_REAL(trH0H0L3L3)+96*GSL_REAL(gsl_complex_mul(trH1,trH1L1L1))+32*dim*GSL_REAL(trH2L1H3L0)+32*GSL_REAL(gsl_complex_mul(trL2L3,trL2L3))+8*dim*GSL_REAL(trH3H3H3H3)-16*dim*GSL_REAL(trH0H2H0H2)+32*dim*GSL_REAL(trH2H2H3H3)-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1H3L1)))-96*GSL_REAL(gsl_complex_mul(trH3L3,trH3L3))+32*GSL_REAL(gsl_complex_mul(trH0,trH0H0H0))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1L1H3)))+32*GSL_REAL(gsl_complex_mul(trH0,trH1L2L3))+32*GSL_REAL(gsl_complex_mul(trH1,trH1H1H1))+32*dim*GSL_REAL(trH1H1L3L3)+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1L0H2)))-64*GSL_REAL(gsl_complex_mul(trH0L2,trH1L3))+96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH3,trL1L3L2)))+32*dim*GSL_REAL(trH0H1L3L2)-96*GSL_REAL(gsl_complex_mul(trH0L0,trH0L0))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L1H1,trH3)))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2H3H2))+32*GSL_REAL(gsl_complex_mul(trH1H1H3,trH3))+32*GSL_REAL(gsl_complex_mul(trH1,trH1L2L2))+32*GSL_REAL(gsl_complex_mul(trH1L2L1,trH2))+96*GSL_REAL(gsl_complex_mul(trH2,trH2L0L0))+48*GSL_REAL(gsl_complex_mul(trH2H2,trL0L0))+32*GSL_REAL(gsl_complex_mul(trH1H2,trH1H2))+96*GSL_REAL(gsl_complex_mul(trH0,trH0L1L1))-64*GSL_REAL(gsl_complex_mul(trH0L3,trH1L2))+16*dim*GSL_REAL(trH3L1H3L1)+48*GSL_REAL(gsl_complex_mul(trH0H0,trL0L0))+32*dim*GSL_REAL(trH1H1L1L1)-32*GSL_REAL(gsl_complex_mul(trH1,trH3L0L2))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H2L0,trH1)))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1H2L0))+48*GSL_REAL(gsl_complex_mul(trH2H2,trL2L2))+32*dim*GSL_REAL(trH2H3L1L0)-96*GSL_REAL(gsl_complex_mul(trH0L1,trH0L1))-16*dim*GSL_REAL(trH2L1H2L1)+32*dim*GSL_REAL(trH1L1L2H2)+16*dim*GSL_REAL(trH3L3H3L3)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L3L2L0))+32*GSL_REAL(gsl_complex_mul(trH2,trH3L0L1))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L0L2L3))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H3L3H2))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0H1H2))+96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trL0L3L1)))+48*GSL_REAL(gsl_complex_mul(trH1H1,trL1L1))+16*GSL_REAL(gsl_complex_mul(trH0H0,trH3H3))-16*dim*GSL_REAL(trL1L2L1L2)+32*dim*GSL_REAL(trH3H3L0L0)+32*GSL_REAL(gsl_complex_mul(trH0,trH0H1H1))+96*GSL_REAL(gsl_complex_mul(trH2,trH2L3L3))+8*dim*GSL_REAL(trL1L1L1L1)-64*GSL_REAL(gsl_complex_mul(trH0H2,trL1L3))-32*dim*GSL_REAL(trH0H3L0L3)-16*dim*GSL_REAL(trH0H3H0H3)-32*dim*GSL_REAL(trH0L3L0H3)-96*GSL_REAL(gsl_complex_mul(trH2L0,trH2L0))+32*GSL_REAL(gsl_complex_mul(trH0,trH0L3L3))-96*GSL_REAL(gsl_complex_mul(trH2L3,trH2L3))+32*dim*GSL_REAL(trH1H1H2H2)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L2L3L1))+32*dim*GSL_REAL(trL0L0L3L3)+96*GSL_REAL(gsl_complex_mul(trH0,trH0L2L2))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2L1L0))+32*GSL_REAL(gsl_complex_mul(trL0L2,trL0L2))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L0H2,trH1)))+32*GSL_REAL(gsl_complex_mul(trH0,trH0H3H3))-64*GSL_REAL(gsl_complex_mul(trH0L3,trH3L0))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3H3H2))+8*dim*GSL_REAL(trH1H1H1H1)+32*dim*GSL_REAL(trH1H1H3H3)+32*dim*GSL_REAL(trL2L2L3L3)-64*GSL_REAL(gsl_complex_mul(trH1L2,trH2L1))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1L0L2))+32*GSL_REAL(gsl_complex_mul(trL1L2,trL1L2))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3L2H2))-32*dim*GSL_REAL(trH1L0L2H3)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3H1L1))+32*GSL_REAL(gsl_complex_mul(trH2H3,trH2H3))+32*dim*GSL_REAL(trH3H3L1L1)-16*dim*GSL_REAL(trL0L2L0L2)+48*GSL_REAL(gsl_complex_mul(trH1H1,trL0L0))+32*GSL_REAL(gsl_complex_mul(trH2,trH2L1L1))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L1L3L0))+48*GSL_REAL(gsl_complex_mul(trH3H3,trL3L3))+32*GSL_REAL(gsl_complex_mul(trL0L1,trL0L1))-64*GSL_REAL(gsl_complex_mul(trH1L1,trH2L2))-32*dim*GSL_REAL(trH0L1L3H2)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L0L1L3))-32*GSL_REAL(gsl_complex_mul(trH0L3L1,trH2))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trH2L3H3)))+32*GSL_REAL(gsl_complex_mul(trH1,trH2L2L1))+64*GSL_REAL(gsl_complex_mul(trH0L3,trH2L1))+32*dim*GSL_REAL(trH2H2L1L1)+32*dim*GSL_REAL(trH1L1H2L2)-32*GSL_REAL(gsl_complex_mul(trH0L3,trH0L3))+64*GSL_REAL(gsl_complex_mul(trH2H3,trL0L1))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H3H2L3))+48*GSL_REAL(gsl_complex_mul(trH3H3,trL1L1))+16*GSL_REAL(gsl_complex_mul(trH3H3,trL0L0))+32*GSL_REAL(gsl_complex_mul(trH0H2,trH0H2))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L2H3,trH2)))+32*GSL_REAL(gsl_complex_mul(trH0H1,trH0H1))-32*GSL_REAL(gsl_complex_mul(trH3L0,trH3L0))+24*GSL_REAL(gsl_complex_mul(trL3L3,trL3L3))+32*dim*GSL_REAL(trH2L0L1H3)-32*GSL_REAL(gsl_complex_mul(trH0,trH2L1L3))-96*GSL_REAL(gsl_complex_mul(trH3L1,trH3L1))+24*GSL_REAL(gsl_complex_mul(trH0H0,trH0H0))+32*dim*GSL_REAL(trH0L3H1L2)+32*dim*GSL_REAL(trH0H0L2L2)-32*dim*GSL_REAL(trH0H1L2L3)+32*GSL_REAL(gsl_complex_mul(trH1H3,trH1H3))-96*GSL_REAL(gsl_complex_mul(trH1L0,trH1L0))+32*GSL_REAL(gsl_complex_mul(trH2,trH2H3H3))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2L2H3))+96*GSL_REAL(gsl_complex_mul(trH1,trH1L0L0))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1H2L3,trH3)))+32*GSL_REAL(gsl_complex_mul(trH0H0H1,trH1))+32*dim*GSL_REAL(trH2L0H3L1)+16*dim*GSL_REAL(trH0L0H0L0)-64*GSL_REAL(gsl_complex_mul(trH2L1,trH3L0))+16*GSL_REAL(gsl_complex_mul(trH1H1,trH2H2))+16*dim*GSL_REAL(trH1L0H1L0)-32*GSL_REAL(gsl_complex_mul(trH1,trH3L2L0))+24*GSL_REAL(gsl_complex_mul(trH3H3,trH3H3))+96*GSL_REAL(gsl_complex_mul(trH3,trH3L2L2))+16*GSL_REAL(gsl_complex_mul(trL0L0,trL1L1))+24*GSL_REAL(gsl_complex_mul(trL2L2,trL2L2))+8*dim*GSL_REAL(trH0H0H0H0)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1H3L1))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trH2H3L3)))-16*dim*GSL_REAL(trH1L2H1L2)-64*GSL_REAL(gsl_complex_mul(trH2L0,trH3L1))+32*dim*GSL_REAL(trH3H3L3L3)+16*GSL_REAL(gsl_complex_mul(trH0H0,trH1H1))+32*GSL_REAL(gsl_complex_mul(trH0L0L3,trH3))+32*dim*GSL_REAL(trH0H0H3H3)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1L0H2))+8*dim*GSL_REAL(trH2H2H2H2)+32*GSL_REAL(gsl_complex_mul(trH0H0H2,trH2))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L2L3L0))+32*dim*GSL_REAL(trH2H2L0L0)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1H3H1))+32*GSL_REAL(gsl_complex_mul(trH3,trH3L0L0))+16*dim*GSL_REAL(trH1L1H1L1)+32*dim*GSL_REAL(trH0L2L3H1)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2L0H1))+24*GSL_REAL(gsl_complex_mul(trL0L0,trL0L0))+32*dim*GSL_REAL(trH0H3L3L0)+96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trL0L2L1)))+24*GSL_REAL(gsl_complex_mul(trL1L1,trL1L1))-32*dim*GSL_REAL(trH1H2L1L2)-64*GSL_REAL(gsl_complex_mul(trH0L0,trH3L3))+32*GSL_REAL(gsl_complex_mul(trH0L2L3,trH1))+32*GSL_REAL(gsl_complex_mul(trH0,trH1L3L2))+32*dim*GSL_REAL(trH0L2H1L3)+32*dim*GSL_REAL(trH1L2L0H3)+32*GSL_REAL(gsl_complex_mul(trH2L1L0,trH3))-64*GSL_REAL(gsl_complex_mul(trH1H3,trL0L2))+16*dim*GSL_REAL(trH2L2H2L2)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L3L0L2))+48*GSL_REAL(gsl_complex_mul(trH3H3,trL2L2))-32*GSL_REAL(gsl_complex_mul(trH0L1L3,trH2))-32*dim*GSL_REAL(trH1H3L2L0)-16*dim*GSL_REAL(trH3L0H3L0)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L2L1L3))+32*GSL_REAL(gsl_complex_mul(trH1,trH1H3H3))+16*GSL_REAL(gsl_complex_mul(trH1H1,trH3H3))+32*GSL_REAL(gsl_complex_mul(trH2L0L1,trH3))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L1L2L3))+48*GSL_REAL(gsl_complex_mul(trH1H1,trL3L3))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1L2L0))+16*GSL_REAL(gsl_complex_mul(trH0H0,trL3L3))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1H3L3,trH2)))+48*GSL_REAL(gsl_complex_mul(trH0H0,trL1L1))+32*GSL_REAL(gsl_complex_mul(trH1L1L2,trH2))+8*dim*GSL_REAL(trL2L2L2L2)+32*dim*GSL_REAL(trH0H0H1H1)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2H2H3))+16*dim*GSL_REAL(trH2L3H2L3)+16*dim*GSL_REAL(trH3L2H3L2)+64*GSL_REAL(gsl_complex_mul(trH0H3,trL0L3))+32*dim*GSL_REAL(trL1L1L2L2)+16*GSL_REAL(gsl_complex_mul(trH0H0,trH2H2))-16*dim*GSL_REAL(trL2L3L2L3)+32*dim*GSL_REAL(trH0H2L1L3)-32*GSL_REAL(gsl_complex_mul(trH1L0L2,trH3))+16*dim*GSL_REAL(trH1L3H1L3)+64*GSL_REAL(gsl_complex_mul(trH0L1,trH2L3))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H3L1,trH1)))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1L3H3,trH2)))+96*GSL_REAL(gsl_complex_mul(trH1,trH1L3L3))+16*dim*GSL_REAL(trH0L2H0L2)-16*dim*GSL_REAL(trH2H3H2H3)+16*GSL_REAL(gsl_complex_mul(trL2L2,trL3L3))+32*dim*GSL_REAL(trH1H1L2L2)+32*dim*GSL_REAL(trH0L3L1H2)+32*GSL_REAL(gsl_complex_mul(trH0L3L0,trH3))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0L2L1))+32*GSL_REAL(gsl_complex_mul(trH0L3L2,trH1))-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3L0L1))-32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L1H3,trH1)))+8*dim*GSL_REAL(trL3L3L3L3)+16*GSL_REAL(gsl_complex_mul(trL0L0,trL3L3))-16*dim*GSL_REAL(trH1H2H1H2)+8*dim*GSL_REAL(trL0L0L0L0)+48*GSL_REAL(gsl_complex_mul(trH2H2,trL3L3))+32*GSL_REAL(gsl_complex_mul(trH2,trH3L1L0))+16*GSL_REAL(gsl_complex_mul(trH1H1,trL2L2))-96*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trL0L1L2)))+32*dim*GSL_REAL(trH0H0L1L1)-32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H2H3L3))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0H2H1))+32*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H3L2,trH2)))+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L1L0L3))+32*dim*GSL_REAL(trH1L2H2L1)+32*dim*GSL_REAL(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L2L0L3))+32*dim*GSL_REAL(trL0L0L2L2)-16*dim*GSL_REAL(trL0L1L0L1)+32*dim*GSL_REAL(trH1H3L0L2)-16*dim*GSL_REAL(trH0L3H0L3)+16*GSL_REAL(gsl_complex_mul(trL1L1,trL2L2))+16*GSL_REAL(gsl_complex_mul(trH2H2,trL1L1))+32*GSL_REAL(gsl_complex_mul(trL1L3,trL1L3))+64*GSL_REAL(gsl_complex_mul(trH1L2,trH3L0))+32*GSL_REAL(gsl_complex_mul(trH0H0H3,trH3))+32*GSL_REAL(gsl_complex_mul(trH1,trH1H2H2));
    if(control[1])
    vecS[1] = G*(+8*dim*GSL_IMAG(trH1H1)+8*GSL_IMAG(gsl_complex_mul(trH1,trH1))+8*GSL_IMAG(gsl_complex_mul(trH3,trH3))+8*dim*GSL_IMAG(trL1L1)+8*dim*GSL_IMAG(trH0H0)+8*dim*GSL_IMAG(trH2H2)+8*dim*GSL_IMAG(trL2L2)+8*dim*GSL_IMAG(trH3H3)+8*GSL_IMAG(gsl_complex_mul(trH2,trH2))+8*dim*GSL_IMAG(trL0L0)+8*GSL_IMAG(gsl_complex_mul(trH0,trH0))+8*dim*GSL_IMAG(trL3L3)) -32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H1L0,trH2)))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH2L2H3)))+32*dim*GSL_IMAG(trH0L3H3L0)+32*GSL_IMAG(gsl_complex_mul(trH2,trH2H2H2))-32*GSL_IMAG(gsl_complex_mul(trH2L1,trH2L1))-32*GSL_IMAG(gsl_complex_mul(trH1L2,trH1L2))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L3L1L2))+48*GSL_IMAG(gsl_complex_mul(trH0H0,trL2L2))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L2H2,trH3)))+32*GSL_IMAG(gsl_complex_mul(trH0,trH3L0L3))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H2L3H3))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L0H1,trH2)))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3H2H3))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1H1H3))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L0L3L1))+32*GSL_IMAG(gsl_complex_mul(trH1,trH2L1L2))-96*GSL_IMAG(gsl_complex_mul(trH2L2,trH2L2))-96*GSL_IMAG(gsl_complex_mul(trH0L2,trH0L2))-96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trL0L1L3)))+24*GSL_IMAG(gsl_complex_mul(trH1H1,trH1H1))-96*GSL_IMAG(gsl_complex_mul(trH1L1,trH1L1))-32*dim*GSL_IMAG(trH1L0H3L2)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0L1L2))-96*GSL_IMAG(gsl_complex_mul(trH3L2,trH3L2))+64*GSL_IMAG(gsl_complex_mul(trH0H1,trL2L3))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H2L2,trH3)))+32*dim*GSL_IMAG(trH1H1L0L0)-32*dim*GSL_IMAG(trH1L2L1H2)-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H1L1,trH3)))-32*GSL_IMAG(gsl_complex_mul(trH1L2L0,trH3))-16*dim*GSL_IMAG(trL0L3L0L3)-32*GSL_IMAG(gsl_complex_mul(trH0,trH2L3L1))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH2H3L2)))-16*dim*GSL_IMAG(trH1H3H1H3)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3L1L0))+32*GSL_IMAG(gsl_complex_mul(trH2H2H3,trH3))-32*dim*GSL_IMAG(trH2H3L0L1)+32*dim*GSL_IMAG(trH0H0H2H2)+96*GSL_IMAG(gsl_complex_mul(trH3,trH3L1L1))-32*dim*GSL_IMAG(trH2L1L0H3)-96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH3,trL1L2L3)))+32*GSL_IMAG(gsl_complex_mul(trH0,trH0H2H2))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1H2L0)))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2H3L2))+32*GSL_IMAG(gsl_complex_mul(trH1H1H2,trH2))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L1L3L2))+24*GSL_IMAG(gsl_complex_mul(trH2H2,trH2H2))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2L0L1))+64*GSL_IMAG(gsl_complex_mul(trH1L0,trH3L2))+32*dim*GSL_IMAG(trH2H2L3L3)+32*dim*GSL_IMAG(trH1H2L2L1)+96*GSL_IMAG(gsl_complex_mul(trH0,trH0L0L0))+32*GSL_IMAG(gsl_complex_mul(trH3,trH3H3H3))+32*dim*GSL_IMAG(trH0H0L0L0)+32*dim*GSL_IMAG(trL1L1L3L3)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2H1L0))-32*dim*GSL_IMAG(trH0L3H2L1)+16*GSL_IMAG(gsl_complex_mul(trL0L0,trL2L2))+32*dim*GSL_IMAG(trH0L0L3H3)+16*GSL_IMAG(gsl_complex_mul(trL1L1,trL3L3))-96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH2,trL0L2L3)))+96*GSL_IMAG(gsl_complex_mul(trH3,trH3L3L3))+16*dim*GSL_IMAG(trH2L0H2L0)+32*GSL_IMAG(gsl_complex_mul(trH0H3,trH0H3))-16*dim*GSL_IMAG(trH0H1H0H1)+32*dim*GSL_IMAG(trH2H2L2L2)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L0L3L2))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L3L2L1))-32*dim*GSL_IMAG(trH1L2H3L0)+16*dim*GSL_IMAG(trH0L1H0L1)-16*dim*GSL_IMAG(trL1L3L1L3)-96*GSL_IMAG(gsl_complex_mul(trH1L3,trH1L3))+96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH2,trL0L3L2)))-32*dim*GSL_IMAG(trH0H2L3L1)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3H2L2))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3L1H1))+32*dim*GSL_IMAG(trH0L0H3L3)+64*GSL_IMAG(gsl_complex_mul(trH1H2,trL1L2))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1L3H2,trH3)))+16*GSL_IMAG(gsl_complex_mul(trH2H2,trH3H3))+32*dim*GSL_IMAG(trH3H3L2L2)-32*dim*GSL_IMAG(trH0L1H2L3)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1L1H3))+32*dim*GSL_IMAG(trL0L0L1L1)+32*GSL_IMAG(gsl_complex_mul(trH0,trH3L3L0))-32*dim*GSL_IMAG(trH0L3L2H1)+32*GSL_IMAG(gsl_complex_mul(trL0L3,trL0L3))+96*GSL_IMAG(gsl_complex_mul(trH2,trH2L2L2))+32*dim*GSL_IMAG(trH0H0L3L3)+96*GSL_IMAG(gsl_complex_mul(trH1,trH1L1L1))+32*dim*GSL_IMAG(trH2L1H3L0)+32*GSL_IMAG(gsl_complex_mul(trL2L3,trL2L3))+8*dim*GSL_IMAG(trH3H3H3H3)-16*dim*GSL_IMAG(trH0H2H0H2)+32*dim*GSL_IMAG(trH2H2H3H3)-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1H3L1)))-96*GSL_IMAG(gsl_complex_mul(trH3L3,trH3L3))+32*GSL_IMAG(gsl_complex_mul(trH0,trH0H0H0))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1L1H3)))+32*GSL_IMAG(gsl_complex_mul(trH0,trH1L2L3))+32*GSL_IMAG(gsl_complex_mul(trH1,trH1H1H1))+32*dim*GSL_IMAG(trH1H1L3L3)+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trH1L0H2)))-64*GSL_IMAG(gsl_complex_mul(trH0L2,trH1L3))+96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH3,trL1L3L2)))+32*dim*GSL_IMAG(trH0H1L3L2)-96*GSL_IMAG(gsl_complex_mul(trH0L0,trH0L0))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L1H1,trH3)))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2H3H2))+32*GSL_IMAG(gsl_complex_mul(trH1H1H3,trH3))+32*GSL_IMAG(gsl_complex_mul(trH1,trH1L2L2))+32*GSL_IMAG(gsl_complex_mul(trH1L2L1,trH2))+96*GSL_IMAG(gsl_complex_mul(trH2,trH2L0L0))+48*GSL_IMAG(gsl_complex_mul(trH2H2,trL0L0))+32*GSL_IMAG(gsl_complex_mul(trH1H2,trH1H2))+96*GSL_IMAG(gsl_complex_mul(trH0,trH0L1L1))-64*GSL_IMAG(gsl_complex_mul(trH0L3,trH1L2))+16*dim*GSL_IMAG(trH3L1H3L1)+48*GSL_IMAG(gsl_complex_mul(trH0H0,trL0L0))+32*dim*GSL_IMAG(trH1H1L1L1)-32*GSL_IMAG(gsl_complex_mul(trH1,trH3L0L2))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H2L0,trH1)))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1H2L0))+48*GSL_IMAG(gsl_complex_mul(trH2H2,trL2L2))+32*dim*GSL_IMAG(trH2H3L1L0)-96*GSL_IMAG(gsl_complex_mul(trH0L1,trH0L1))-16*dim*GSL_IMAG(trH2L1H2L1)+32*dim*GSL_IMAG(trH1L1L2H2)+16*dim*GSL_IMAG(trH3L3H3L3)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L3L2L0))+32*GSL_IMAG(gsl_complex_mul(trH2,trH3L0L1))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L0L2L3))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H3L3H2))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0H1H2))+96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trL0L3L1)))+48*GSL_IMAG(gsl_complex_mul(trH1H1,trL1L1))+16*GSL_IMAG(gsl_complex_mul(trH0H0,trH3H3))-16*dim*GSL_IMAG(trL1L2L1L2)+32*dim*GSL_IMAG(trH3H3L0L0)+32*GSL_IMAG(gsl_complex_mul(trH0,trH0H1H1))+96*GSL_IMAG(gsl_complex_mul(trH2,trH2L3L3))+8*dim*GSL_IMAG(trL1L1L1L1)-64*GSL_IMAG(gsl_complex_mul(trH0H2,trL1L3))-32*dim*GSL_IMAG(trH0H3L0L3)-16*dim*GSL_IMAG(trH0H3H0H3)-32*dim*GSL_IMAG(trH0L3L0H3)-96*GSL_IMAG(gsl_complex_mul(trH2L0,trH2L0))+32*GSL_IMAG(gsl_complex_mul(trH0,trH0L3L3))-96*GSL_IMAG(gsl_complex_mul(trH2L3,trH2L3))+32*dim*GSL_IMAG(trH1H1H2H2)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L2L3L1))+32*dim*GSL_IMAG(trL0L0L3L3)+96*GSL_IMAG(gsl_complex_mul(trH0,trH0L2L2))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2L1L0))+32*GSL_IMAG(gsl_complex_mul(trL0L2,trL0L2))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L0H2,trH1)))+32*GSL_IMAG(gsl_complex_mul(trH0,trH0H3H3))-64*GSL_IMAG(gsl_complex_mul(trH0L3,trH3L0))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3H3H2))+8*dim*GSL_IMAG(trH1H1H1H1)+32*dim*GSL_IMAG(trH1H1H3H3)+32*dim*GSL_IMAG(trL2L2L3L3)-64*GSL_IMAG(gsl_complex_mul(trH1L2,trH2L1))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1L0L2))+32*GSL_IMAG(gsl_complex_mul(trL1L2,trL1L2))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3L2H2))-32*dim*GSL_IMAG(trH1L0L2H3)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H3H1L1))+32*GSL_IMAG(gsl_complex_mul(trH2H3,trH2H3))+32*dim*GSL_IMAG(trH3H3L1L1)-16*dim*GSL_IMAG(trL0L2L0L2)+48*GSL_IMAG(gsl_complex_mul(trH1H1,trL0L0))+32*GSL_IMAG(gsl_complex_mul(trH2,trH2L1L1))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L1L3L0))+48*GSL_IMAG(gsl_complex_mul(trH3H3,trL3L3))+32*GSL_IMAG(gsl_complex_mul(trL0L1,trL0L1))-64*GSL_IMAG(gsl_complex_mul(trH1L1,trH2L2))-32*dim*GSL_IMAG(trH0L1L3H2)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L0L1L3))-32*GSL_IMAG(gsl_complex_mul(trH0L3L1,trH2))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trH2L3H3)))+32*GSL_IMAG(gsl_complex_mul(trH1,trH2L2L1))+64*GSL_IMAG(gsl_complex_mul(trH0L3,trH2L1))+32*dim*GSL_IMAG(trH2H2L1L1)+32*dim*GSL_IMAG(trH1L1H2L2)-32*GSL_IMAG(gsl_complex_mul(trH0L3,trH0L3))+64*GSL_IMAG(gsl_complex_mul(trH2H3,trL0L1))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H3H2L3))+48*GSL_IMAG(gsl_complex_mul(trH3H3,trL1L1))+16*GSL_IMAG(gsl_complex_mul(trH3H3,trL0L0))+32*GSL_IMAG(gsl_complex_mul(trH0H2,trH0H2))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L2H3,trH2)))+32*GSL_IMAG(gsl_complex_mul(trH0H1,trH0H1))-32*GSL_IMAG(gsl_complex_mul(trH3L0,trH3L0))+24*GSL_IMAG(gsl_complex_mul(trL3L3,trL3L3))+32*dim*GSL_IMAG(trH2L0L1H3)-32*GSL_IMAG(gsl_complex_mul(trH0,trH2L1L3))-96*GSL_IMAG(gsl_complex_mul(trH3L1,trH3L1))+24*GSL_IMAG(gsl_complex_mul(trH0H0,trH0H0))+32*dim*GSL_IMAG(trH0L3H1L2)+32*dim*GSL_IMAG(trH0H0L2L2)-32*dim*GSL_IMAG(trH0H1L2L3)+32*GSL_IMAG(gsl_complex_mul(trH1H3,trH1H3))-96*GSL_IMAG(gsl_complex_mul(trH1L0,trH1L0))+32*GSL_IMAG(gsl_complex_mul(trH2,trH2H3H3))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2L2H3))+96*GSL_IMAG(gsl_complex_mul(trH1,trH1L0L0))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1H2L3,trH3)))+32*GSL_IMAG(gsl_complex_mul(trH0H0H1,trH1))+32*dim*GSL_IMAG(trH2L0H3L1)+16*dim*GSL_IMAG(trH0L0H0L0)-64*GSL_IMAG(gsl_complex_mul(trH2L1,trH3L0))+16*GSL_IMAG(gsl_complex_mul(trH1H1,trH2H2))+16*dim*GSL_IMAG(trH1L0H1L0)-32*GSL_IMAG(gsl_complex_mul(trH1,trH3L2L0))+24*GSL_IMAG(gsl_complex_mul(trH3H3,trH3H3))+96*GSL_IMAG(gsl_complex_mul(trH3,trH3L2L2))+16*GSL_IMAG(gsl_complex_mul(trL0L0,trL1L1))+24*GSL_IMAG(gsl_complex_mul(trL2L2,trL2L2))+8*dim*GSL_IMAG(trH0H0H0H0)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1H3L1))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1,trH2H3L3)))-16*dim*GSL_IMAG(trH1L2H1L2)-64*GSL_IMAG(gsl_complex_mul(trH2L0,trH3L1))+32*dim*GSL_IMAG(trH3H3L3L3)+16*GSL_IMAG(gsl_complex_mul(trH0H0,trH1H1))+32*GSL_IMAG(gsl_complex_mul(trH0L0L3,trH3))+32*dim*GSL_IMAG(trH0H0H3H3)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H1L0H2))+8*dim*GSL_IMAG(trH2H2H2H2)+32*GSL_IMAG(gsl_complex_mul(trH0H0H2,trH2))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L2L3L0))+32*dim*GSL_IMAG(trH2H2L0L0)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1H3H1))+32*GSL_IMAG(gsl_complex_mul(trH3,trH3L0L0))+16*dim*GSL_IMAG(trH1L1H1L1)+32*dim*GSL_IMAG(trH0L2L3H1)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0H2L0H1))+24*GSL_IMAG(gsl_complex_mul(trL0L0,trL0L0))+32*dim*GSL_IMAG(trH0H3L3L0)+96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trL0L2L1)))+24*GSL_IMAG(gsl_complex_mul(trL1L1,trL1L1))-32*dim*GSL_IMAG(trH1H2L1L2)-64*GSL_IMAG(gsl_complex_mul(trH0L0,trH3L3))+32*GSL_IMAG(gsl_complex_mul(trH0L2L3,trH1))+32*GSL_IMAG(gsl_complex_mul(trH0,trH1L3L2))+32*dim*GSL_IMAG(trH0L2H1L3)+32*dim*GSL_IMAG(trH1L2L0H3)+32*GSL_IMAG(gsl_complex_mul(trH2L1L0,trH3))-64*GSL_IMAG(gsl_complex_mul(trH1H3,trL0L2))+16*dim*GSL_IMAG(trH2L2H2L2)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L3L0L2))+48*GSL_IMAG(gsl_complex_mul(trH3H3,trL2L2))-32*GSL_IMAG(gsl_complex_mul(trH0L1L3,trH2))-32*dim*GSL_IMAG(trH1H3L2L0)-16*dim*GSL_IMAG(trH3L0H3L0)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L2L1L3))+32*GSL_IMAG(gsl_complex_mul(trH1,trH1H3H3))+16*GSL_IMAG(gsl_complex_mul(trH1H1,trH3H3))+32*GSL_IMAG(gsl_complex_mul(trH2L0L1,trH3))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH3L1L2L3))+48*GSL_IMAG(gsl_complex_mul(trH1H1,trL3L3))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L1L2L0))+16*GSL_IMAG(gsl_complex_mul(trH0H0,trL3L3))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1H3L3,trH2)))+48*GSL_IMAG(gsl_complex_mul(trH0H0,trL1L1))+32*GSL_IMAG(gsl_complex_mul(trH1L1L2,trH2))+8*dim*GSL_IMAG(trL2L2L2L2)+32*dim*GSL_IMAG(trH0H0H1H1)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L2H2H3))+16*dim*GSL_IMAG(trH2L3H2L3)+16*dim*GSL_IMAG(trH3L2H3L2)+64*GSL_IMAG(gsl_complex_mul(trH0H3,trL0L3))+32*dim*GSL_IMAG(trL1L1L2L2)+16*GSL_IMAG(gsl_complex_mul(trH0H0,trH2H2))-16*dim*GSL_IMAG(trL2L3L2L3)+32*dim*GSL_IMAG(trH0H2L1L3)-32*GSL_IMAG(gsl_complex_mul(trH1L0L2,trH3))+16*dim*GSL_IMAG(trH1L3H1L3)+64*GSL_IMAG(gsl_complex_mul(trH0L1,trH2L3))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H3L1,trH1)))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH1L3H3,trH2)))+96*GSL_IMAG(gsl_complex_mul(trH1,trH1L3L3))+16*dim*GSL_IMAG(trH0L2H0L2)-16*dim*GSL_IMAG(trH2H3H2H3)+16*GSL_IMAG(gsl_complex_mul(trL2L2,trL3L3))+32*dim*GSL_IMAG(trH1H1L2L2)+32*dim*GSL_IMAG(trH0L3L1H2)+32*GSL_IMAG(gsl_complex_mul(trH0L3L0,trH3))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0L2L1))+32*GSL_IMAG(gsl_complex_mul(trH0L3L2,trH1))-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L3L0L1))-32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0L1H3,trH1)))+8*dim*GSL_IMAG(trL3L3L3L3)+16*GSL_IMAG(gsl_complex_mul(trL0L0,trL3L3))-16*dim*GSL_IMAG(trH1H2H1H2)+8*dim*GSL_IMAG(trL0L0L0L0)+48*GSL_IMAG(gsl_complex_mul(trH2H2,trL3L3))+32*GSL_IMAG(gsl_complex_mul(trH2,trH3L1L0))+16*GSL_IMAG(gsl_complex_mul(trH1H1,trL2L2))-96*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0,trL0L1L2)))+32*dim*GSL_IMAG(trH0H0L1L1)-32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1H2H3L3))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH0L0H2H1))+32*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.),gsl_complex_mul(trH0H3L2,trH2)))+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH1L1L0L3))+32*dim*GSL_IMAG(trH1L2H2L1)+32*dim*GSL_IMAG(gsl_complex_mul(gsl_complex_rect(0., 1.), trH2L2L0L3))+32*dim*GSL_IMAG(trL0L0L2L2)-16*dim*GSL_IMAG(trL0L1L0L1)+32*dim*GSL_IMAG(trH1H3L0L2)-16*dim*GSL_IMAG(trH0L3H0L3)+16*GSL_IMAG(gsl_complex_mul(trL1L1,trL2L2))+16*GSL_IMAG(gsl_complex_mul(trH2H2,trL1L1))+32*GSL_IMAG(gsl_complex_mul(trL1L3,trL1L3))+64*GSL_IMAG(gsl_complex_mul(trH1L2,trH3L0))+32*GSL_IMAG(gsl_complex_mul(trH0H0H3,trH3))+32*GSL_IMAG(gsl_complex_mul(trH1,trH1H2H2));
    if(control[2])
    vecS[2] = GSL_REAL(trH0);
    if(control[3])
    vecS[3] = GSL_REAL(trH0H0);
